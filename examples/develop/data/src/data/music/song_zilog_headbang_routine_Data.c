...
static const hUGEDutyInstr_t duty_instruments[] = {
    ...
    { 0x00, 0x80, 0xF0, 0, 0x80 },
    { 0x00, 0x80, 0xF0, 0, 0x80 },
    { 0x00, 0x80, 0x10, 0, 0x80 },
    { 0x00, 0x80, 0x64, 0, 0x80 },
    { 0x00, 0x00, 0x70, 0, 0x80 },
    { 0x00, 0x80, 0xF0, 0, 0x80 },
    { 0x00, 0x80, 0xF0, 0, 0x80 },
    { 0x00, 0x80, 0xF0, 0, 0x80 },
    { 0x00, 0x80, 0xF0, 0, 0x80 },
...
const void __at(255) __bank_song_zilog_headbang_routine_Data;
const hUGESong_t song_zilog_headbang_routine_Data = {
    7,
    &order_cnt,
