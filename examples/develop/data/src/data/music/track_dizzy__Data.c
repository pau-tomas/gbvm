...
const void __at(255) __bank_track_dizzy__Data;
const hUGESong_t track_dizzy__Data = {2, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
